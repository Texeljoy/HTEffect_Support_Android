...
public class HtFunnyFilterConfig {

  /**
   * stickers
   */
  private List<HtFunnyFilter> ht_haha_filter;
  ...
  public List<HtFunnyFilter> getFilters() {
    return ht_haha_filter;
  }

  public HtFunnyFilterConfig(List<HtFunnyFilter> filters) {
    this.ht_haha_filter = filters;
  }

  public void setFilters(List<HtFunnyFilter> htFilters) { this.ht_haha_filter = htFilters;}

  public static class HtFunnyFilter {

    public static final HtFunnyFilter NO_FILTER = new HtFunnyFilter("","","", "", "", 2);

    public HtFunnyFilter(String title, String titleEn, String name, String category, String icon, int download) {
      this.title = title;
